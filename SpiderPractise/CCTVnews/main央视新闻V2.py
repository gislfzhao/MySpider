...
def process_early_new_content(text):
    ...
    while child is not None:
        ...
        elif child.tag == 'ul' and child.find('li') is not None:
...
def main():
    ...
    while d <= end:
        ...
        early_news['url'] = 'https://mp.weixin.qq.com/s?__biz=MTI0MDU3NDYwMQ==&mid=2656733673&idx=1&sn=28bc20d0e797066fc6e4c5d8ca98dfb3&chksm=7a60740f4d17fd199afd9ca2403f2d16ce5deb8eb90a77eeca538b956f0fc61fd44990dca86e&xtrack=1&scene=0&subscene=131&clicktime=1548112744&ascene=7&devicetype=android-28&version=2700003b&nettype=WIFI&abtest_cookie=BQABAAoACwASABMAFAAGACOXHgBamR4Am5keAJ2ZHgC3mR4A2pkeAAAA&lang=zh_CN&pass_ticket=ngNkUy7JKyNAI0WrbiOkpISz%2B2KHzrBqNau6uRNORMbZ9FN4tmw%2F8Kgg%2Fv8lnlw5&wx_header=1'
        print(early_news)
